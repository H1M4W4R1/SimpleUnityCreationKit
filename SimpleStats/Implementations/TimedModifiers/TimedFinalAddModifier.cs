...
{
    /// <summary>
    ///     Final add modifier with a limited duration.
    ...
    /// </summary>
    [Serializable]
    public class TimedFinalAddModifier<TStatisticType> : IStatModifier<TStatisticType>, ITimedModifier
        where TStatisticType : StatisticBase
    {
        ...
        public TimedFinalAddModifier(float baseValue, float duration)
        {
            BaseValue = baseValue;
