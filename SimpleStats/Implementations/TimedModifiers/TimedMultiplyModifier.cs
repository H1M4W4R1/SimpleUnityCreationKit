...
{
    /// <summary>
    ///     Multiply modifier with a limited duration.
    ...
    /// </summary>
    [Serializable]
    public class TimedMultiplyModifier<TStatisticType> : IStatModifier<TStatisticType>, ITimedModifier
        where TStatisticType : StatisticBase
    {
        ...
        public TimedMultiplyModifier(float baseValue, float duration)
        {
            BaseValue = baseValue;
