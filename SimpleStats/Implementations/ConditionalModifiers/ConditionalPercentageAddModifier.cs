...
{
    /// <summary>
    ///     Percentage add modifier that only applies when <see cref="ShouldApply"/> returns true.
    ...
    /// </summary>
    [Serializable]
    public abstract class ConditionalPercentageAddModifier<TStatisticType> : IStatModifier<TStatisticType>, IConditionalModifier
        where TStatisticType : StatisticBase
    {
        ...
        public ConditionalPercentageAddModifier(float baseValue)
        {
            BaseValue = baseValue;
        }
