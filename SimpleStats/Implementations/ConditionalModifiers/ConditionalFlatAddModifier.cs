...
{
    /// <summary>
    ///     Flat add modifier that only applies when <see cref="ShouldApply"/> returns true.
    ...
    /// </summary>
    [Serializable]
    public abstract class ConditionalFlatAddModifier<TStatisticType> : IStatModifier<TStatisticType>, IConditionalModifier
        where TStatisticType : StatisticBase
    {
        ...
        public ConditionalFlatAddModifier(float baseValue)
        {
            BaseValue = baseValue;
        }
