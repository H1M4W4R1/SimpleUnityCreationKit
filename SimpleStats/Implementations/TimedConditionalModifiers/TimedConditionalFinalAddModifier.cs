...
{
    /// <summary>
    ///     Final add modifier that is both time-limited and conditional.
    ...
    /// </summary>
    [Serializable]
    public abstract class TimedConditionalFinalAddModifier<TStatisticType>
        ...
        where TStatisticType : StatisticBase
    {
        ...
        public TimedConditionalFinalAddModifier(float baseValue, float duration)
        {
            BaseValue = baseValue;
