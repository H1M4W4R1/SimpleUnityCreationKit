...
{
    /// <summary>
    ///     Multiply modifier that is both time-limited and conditional.
    ...
    /// </summary>
    [Serializable]
    public abstract class TimedConditionalMultiplyModifier<TStatisticType>
        ...
        where TStatisticType : StatisticBase
    {
        ...
        public TimedConditionalMultiplyModifier(float baseValue, float duration)
        {
            BaseValue = baseValue;
