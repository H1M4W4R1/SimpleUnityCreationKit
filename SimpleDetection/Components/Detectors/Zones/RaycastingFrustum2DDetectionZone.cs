...
{
    [BurstCompile] public readonly struct RaycastingFrustum2DDetectionZone : IDetectionZone
    {
        ...
        public RaycastingFrustum2DDetectionZone(float2 position, float2 forward, float angle, float radius)
        {
